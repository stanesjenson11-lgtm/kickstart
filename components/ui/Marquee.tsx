 ...
 *
 * Adapted from React Bits' LogoLoop for this project: it carries text rather
 * than logos, because the client has no logos to show yet and a marquee of
 * placeholder marks would be worse than none.
 *
 * Decorative: the same words appear as real text in the footer, so this is
 * aria-hidden and nothing is lost when it does not run.
 */
